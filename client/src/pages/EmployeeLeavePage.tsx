    ...
    <div className="animate-page-enter space-y-6">
      ...
      <div className="grid gap-4 xl:grid-cols-[1.05fr_0.95fr]">
        <section className="relative overflow-hidden rounded-[32px] border border-brand-200 bg-[linear-gradient(135deg,rgba(26,42,105,0.96),rgba(59,130,246,0.92))] p-6 text-white shadow-soft">
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.18),transparent_36%),radial-gradient(circle_at_bottom_right,rgba(191,219,254,0.18),transparent_30%)]" />
