  ...
  return (
    <article className="relative overflow-hidden rounded-xl border border-slate-200/80 bg-white/95 p-4 shadow-[0_12px_30px_rgba(15,23,42,0.08)]">
      ...
      <div className="flex items-center justify-between gap-3">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-brand-800">{title}</p>
      ...
      {hint ? <p className="mt-2 text-xs font-medium text-slate-700">{hint}</p> : null}
